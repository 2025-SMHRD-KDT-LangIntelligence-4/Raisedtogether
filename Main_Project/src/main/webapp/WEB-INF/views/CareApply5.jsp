...
<body>
	...
	<div class="container">
		...
		<div class="start-screen">
			<div class="logoAlert">
				<a href="${cpath}/CareApply4"><img class="back"
		...
		<form action="${cpath}/CareApplyPlace" method="post">
			...
			<input type="text" name="careAddress1" class="postcode"
			...
			<input type="text" name="careAddress3" 
				class="extraAddress" id="sample3_extraAddress" placeholder="참고항목">
				
			<input type="text" name="careAddress4" class="detailAddress" id="sample3_detailAddress"
				placeholder="상세주소">
			...
			<div class="input-group">
				<label>특이사항</label>
				<textarea class="textarea-box" name="careNotes" 
					placeholder="예) CCTV가 있어요, 강아지가 있어요 등"></textarea>
			</div>
