...
<title>돌봄 서비스</title>
<link rel="stylesheet" href="${cpath}/css/ViewHaram.css">
</head>
<body>
...
<div class="content-container">
	...
	<div class="start-screen">
		<div class="logoAlert">
			...
			<a><img class="alert-image" src="${cpath}/images/알림버튼.svg"
				alt="로고" /> </a>
		</div>
	</div>
	...
	<div class="container" style="padding-top: 20px">
		<!-- 인삿말 및 신청 버튼 -->
		<div class="care-card">
			<a class="care-button" href="${cpath}/CareApply">
		...
		<div class="care-options">
			...
			<div class="care-option" onclick="location.href='${cpath}/Emergency'"
			...
			<div class="care-option"
				onclick="location.href='${cpath}/realtime-video'"
				style="cursor: pointer;">
				<div class="option-box">
		...
		<div class="container"
			...
			<div class="title">
				같이키움이 <span class="highlight">콕</span> 집은 돌보미 <a class="more"
					href="${cpath}/caregivers.jsp"> 더보기 <img
			...
			<div class="cards-wrapper">
				<c:forEach var="i" begin="1" end="6">
					<a class="card" href="${cpath}/caregivers.jsp"> <img
	...
	<div class="container">
		<div class="title">
			<span class="highlight">긴급돌봄</span>이 가능한 돌보미 <a class="more"
				href="${cpath}/emergencyCare.jsp"> 더보기 <img
				src="${cpath}/images/Chevron right.svg" alt="더보기 아이콘" />
			</a>
		</div>
	</div>
	...
	<div class="scroll-container2">
		<div class="cards-wrapper2">
			<c:forEach var="i" begin="1" end="2">
				<a class="card2" href="${cpath}/caregivers.jsp">
